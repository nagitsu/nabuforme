...
surgimiento de \texttt{word2vec}, se ha reinvigorizado la investigación en el área, y se han
publicado numerosos artículos estudiando los modelos y proponiendo variantes de los mismos.

...
\begin{table}[!h]
    \setlength\tabcolsep{4pt}
    \begin{tabularx}{\textwidth}{cY*{9}{c}}
        \toprule
        \midrule
        \multicolumn{10}{c}{word2vec}\\
        \midrule
        \thead{Id} & \thead{Descripción} & \thead{Algoritmo} & \thead{Dim} &
        \thead{Ven} & \thead{$\alpha$} & \thead{HS} &
        \thead{NS} & \thead{Epochs} & \thead{Corpus}\\
        \midrule
        W01 & Full word2vec, more epochs, with accents &
        skipgram & 300 & 7 & 0.025 & No & 7 & 5 & C01\\
        \midrule
        W02 & Full word2vec, more epochs &
        skipgram & 300 & 7 & 0.025 & No & 7 & 5 & C02\\
        \midrule
        W03 & Full word2vec, extra dimensions &
        skipgram & 500 & 7 & 0.025 & No & 7 & 1 & C02\\
        \midrule
        W04 & Reduced word2vec &
        skipgram & 300 & 7 & 0.025 & No & 7 & 1 & C03\\
        \midrule
        W05 & Bad quality text &
        skipgram & 200 & 7 & 0.025 & No & 7 & 5 & C04\\
    \end{tabularx}
    \begin{tabularx}{\textwidth}{cY*{5}{c}}
        \toprule
        \midrule
        \multicolumn{7}{c}{GloVe}\\
        \midrule
        \thead{Id} & \thead{Descripción} & \thead{Dimensiones} &
        \thead{Ventana} & \thead{$\alpha$} & \thead{Epochs} & \thead{Corpus}\\
        \midrule
        G01 & Full GloVe, more epochs & 300 & 7 & 0.75 & 50 & C02\\
        \midrule
        G02 & Full GloVe, even more epochs & 300 & 7 & 0.75 & 200 & C02\\
        \midrule
        G03 & Full GloVe & 300 & 7 & 0.75 & 15 & C02\\
    \end{tabularx}
    \begin{tabularx}{\textwidth}{cY*{5}{c}}
        \toprule
        \midrule
        \multicolumn{7}{c}{PPMI/SVD}\\
        \midrule
        \thead{id} & \thead{Descripción} & \thead{Dimensiones} &
        \thead{Ventana} & \thead{Suavizado} & \thead{Contexto} & \thead{Corpus}\\
        \midrule
        S01 & Full SVD & 500 & 2 & 0.75 & Sí & C01\\
        \midrule
        S02 & Full SVD, no accents & 500 & 2 & 0.75 & Sí & C02\\
        \midrule
        S03 & Reduced SVD & 300 & 5 & 0.75 & No & C03\\
        \midrule
        \bottomrule
    \end{tabularx}
...
tres días y diez horas (\textit{Full word2vec, more epochs, with accents}, W01). Existe una diferencia
...
Mikolov2013c}, mientras que los vectores en español (particularmente, el modelo W01,
...
\textit{Full word2vec, more epochs, with accents} (W01), el cual utiliza el algoritmo \texttt{word2vec}
...
para el mejor modelo de antes (\textit{Full word2vec, more epochs, with accents}, W01):
...
\begin{table}[!h]
    ...
    \begin{tabularx}{\textwidth}{l*{3}{Z}}
        ...
        \bottomrule
    \end{tabularx}
    \caption{Desempeño del modelo \textit{Full word2vec, more epochs, with accents} (W01) en las

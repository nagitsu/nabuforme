...
% http://home.ustc.edu.cn/~tianfei/Fei%20Tian's%20Homepage_files/papers/coling14_multi_emb.pdf
...
% http://ceur-ws.org/Vol-1404/paper_11.pdf
...
se generaron analogías utilizando conjugaciones verbales específicas de España (en particular, la
...
en base a la ocurrencia en el texto de las palabras utiliaadas en el conjunto de analogías
...
[algo de ocupaciones (A02)? que falla más en ocupaciones que ve menos? plomera, carpintera, etc?]
[o no mencionar nada, son bastante estándares los resultados fuera de eso]
...
cada variante aparece una menor cantidad de veces. Esto coincide con las conclusiones de [Levy
Goldberg neural fact], en la que los autores plantean que la principal fortaleza de
\texttt{word2vec} (específicamente, de Skipgram con negative sampling) radica en la capacidad que
tiene este algoritmo de no sobrerrepresentar palabras demasiado comunes, distribuyendo la
información en los vectores de manera más uniforme.

[by verb conjugation? OV2-4 mejores porque son usos más específicos que el infinitivo, que lleva a
que se mezclen?]




[esto no pasa, si no se consigue un mejor conjunto de pruebas sacar; sino mencionar algo de esto en
el análisis cualitativo, con lo de UTE y ANCAP]
En la tabla [tabla spain-spec] se muestran los resultados de las evaluaciones con los conjuntos de
conjugaciones verbales específicas de España. Es interesante ver cómo los modelos vectoriales que
son entrenados exclusivamente con texto de España obtienen resultados mejores que los entrenados con
todo el texto. Este punto vuelve a resaltar la importancia de la composición del corpus de
entrenamiento, además de indicar una especie de dilución de los vectores de las palabras cuando la
ocurrencia de las palabras está en un subconjunto del texto muy específico del corpus completo.
[tabla spain-spec]


\section{Análisis Cualitativo de Resultados}

- estudiar resultados del most\_similar cualitativamente (tipo lo que hacen al final de paper de word2vec con russian river) (más bien informal)

- e.g. UTE, ANCAP y eso con corpus en español y corpus general; cómo se ``diluyen'' los significados (i.e. no recupera UTE o ANCAP en todo el corpus pero sí sólo en uruguay, a pesar de que ANCAP sólo se menciona en uruguay (o no, pero buscar ejemplo donde sí en otro caso))

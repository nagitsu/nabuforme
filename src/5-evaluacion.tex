...
\begin{table}[!h]
    ...
    \begin{tabularx}{\textwidth}{Y*{8}{c}}
        ...
        \midrule
        \thead{Descripción} & \thead{Algoritmo} & \thead{Dim} &
        \thead{Ventana} & \thead{$\alpha$} & \thead{HS} &
    ...
    \begin{tabularx}{\textwidth}{Y*{5}{c}}
        ...
        \midrule
        \thead{Descripción} & \thead{Dimensiones} & \thead{Ventana} &
        \thead{$\alpha$} & \thead{Epochs} & \thead{Corpus}\\
        \midrule
    ...
    \begin{tabularx}{\textwidth}{Y*{5}{c}}
        ...
        \midrule
        \thead{Descripción} & \thead{Dimensiones} & \thead{Ventana} &
        \thead{Suavizado} & \thead{Contexto} & \thead{Corpus}\\
        \midrule
...
\begin{table}[!h]
    ...
    \begin{tabularx}{\textwidth}{Y*{6}{c}}
        \toprule
        \midrule
        \thead{Modelo} & \thead{Google} & \thead{WordSim\\Relatedness} &
...
\begin{table}[!h]
    ...
    \begin{tabularx}{\textwidth}{Y*{7}{c}|c}
        \toprule
        \midrule
        \thead{Analogía} & \thead{Full\\w2v,\\EA} &
        \thead{Full\\w2v,\\more\\epochs} & \thead{Reduced\\w2v} &
        \thead{Full\\GloVe,\\more\\epochs} & \thead{Full\\GloVe,\\even\\more\\epochs} &
        \thead{Full\\SVD,\\no\\accents} & \thead{Full\\SVD} & \thead{Levy}\\
...
\begin{table}[!h]
    ...
    \begin{tabularx}{\textwidth}{Y*{7}{c}}
        \toprule
        \midrule
        \thead{Conjunto} & \thead{Full\\w2v,\\EA} &
        \thead{Full\\w2v,\\more\\epochs} & \thead{Full\\SVD} &
        \thead{Full\\GloVe,\\more\\epochs} & \thead{Full\\GloVe,\\even\\more\\epochs} &
        \thead{Full\\SVD,\\no\\accents} & \thead{Bad\\quality\\text}\\
        \noalign{\hrule height 1pt}

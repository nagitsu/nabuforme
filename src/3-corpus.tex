...
Entre las opciones consideradas se destacan \textit{Amazon EC2}, \textit{Microsoft Azure} y
...
Sin lugar a dudas podemos afirmar que la elección de contratar un servidor virtual fue una decisión acertada,

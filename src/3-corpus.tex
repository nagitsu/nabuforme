...
Aun así, la investigación del Centro Virtual Cervantes resultó un buen punto de partida para nuestro
...
El proyecto Corpora from the Web (COW)~\cite{CorporaFromTheWeb} es una iniciativa del grupo de gramática
